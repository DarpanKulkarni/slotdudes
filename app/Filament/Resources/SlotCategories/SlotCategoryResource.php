...
namespace App\Filament\Resources\SlotCategories;

use App\Filament\Resources\SlotCategories\Pages\ManageSlotCategories;
...
class SlotCategoryResource extends Resource
{
    protected static ?string $model = SlotCategory::class;
    ...
    {
        return [
            'index' => ManageSlotCategories::route('/'),
        ];
    }
}
