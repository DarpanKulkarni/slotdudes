...
@php
    ...
    $baseClasses = 'inline-flex items-center justify-center text-center rounded-full uppercase font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed';
