...
<body class="">
    <span class="preheader">New content on {{ config('app.name') }}: {{ $title }}</span>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-block">
                                    ...
                                    <br>
                                    <a href="{{ $unsubscribeUrl }}" style="color: #999999; text-decoration: underline; font-size: 12px;">Unsubscribe</a>
                                </td>
                            </tr>
                        </table>
                    </div>
