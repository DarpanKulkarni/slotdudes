...
<body class="">
    <span class="preheader">Confirm your subscription to {{ config('app.name') }}</span>
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                                <tbody>
                                                                    <tr>
                                                                        <td> <a href="{{ $url }}" target="_blank">Confirm Subscription</a> </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </td>
                                            ...
                                            <p>If you didn't sign up for this subscription, you can safely ignore this email.</p>
